...
#
# Usage:
#   sh utils/generate-keys.sh              # Interactive: prints keys, prompts to update .env
#   sh utils/generate-keys.sh --update-env # Prints keys and writes them to .env
#   sh utils/generate-keys.sh | tee keys   # Non-interactive: prints keys only
#
...
#
# Source: https://github.com/supabase/supabase/blob/master/docker/utils/generate-keys.sh
#
